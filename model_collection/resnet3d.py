# Тихо спиздил и ушел - называется "накодил" :D
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
                 ...
                 norm_layer=None, resnet_in_channels=1):
        ...
        self.conv1 = nn.Conv3d(resnet_in_channels, self.inplanes, kernel_size=7, stride=2, padding=3,
                               bias=False)
        ...
        self.avgpool = nn.AdaptiveAvgPool3d((1, 1, None))
        self.harmonic_embedding = HarmonicEmbedding(n_harmonic_functions)
        self.fc = nn.Linear(512 * block.expansion * 2 * 8 * n_harmonic_functions, num_classes)
